...
`);
  ...
  const [
    ...
    { register: registerFilesystem },
    { register: registerTerminal },
  ] = await Promise.all([
    import('./routes/config.js'),
    import('./routes/git.js'),
    import('./routes/github.js'),
    import('./routes/filesystem.js'),
    import('./routes/terminal.js'),
  ]);

  await registerConfig(app, routeCtx);
  await registerGit(app, routeCtx);
  await registerGithub(app, routeCtx);
  await registerFilesystem(app, routeCtx);
  await registerTerminal(app, routeCtx);
